  ...
  return (
    <>
      ...
      <div className="wrap" style={{ paddingTop: "6.5rem", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontWeight: 300, fontSize: "0.92rem", lineHeight: 1.9, color: "var(--color-stone)", maxWidth: "38ch", margin: "0 auto" }}>
          30 ngày tìm lại mạch chữ của mình
        </p>
      </div>

      <div className="wrap" style={{ margin: "4.5rem auto", maxWidth: 440 }}>
        <ImagePlaceholder label="ảnh · trang giấy, chữ viết" aspectRatio="4/5" />
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "2.5rem", textAlign: "center" }}>
        <Motif name="nui-suong" size={42} className="motif-flip" />
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "2.5rem", maxWidth: "56ch" }}>
        <p style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", fontWeight: 300, fontSize: "1.05rem", lineHeight: 1.6, color: "var(--color-ink)", maxWidth: "46ch", margin: "0 auto 1.5rem", textAlign: "center" }}>
          <span style={{ color: "var(--color-stone)", paddingRight: "0.6rem" }}>/</span>
          im lặng - chữ nghĩa là thực tập viết để đưa sự hiện diện của mình về với câu chữ. Khi tâm có mặt, chữ tự nhiên có lực.
          <span style={{ color: "var(--color-stone)", paddingLeft: "0.6rem" }}>/</span>
        </p>
        <p style={{ fontFamily: "var(--font-mono)", fontStyle: "normal", fontSize: "0.72rem", lineHeight: 2, letterSpacing: "0.02em", color: "var(--color-moss)", textAlign: "center", margin: 0 }}>
      ...
      <RevealStagger className="wrap" style={{ marginBottom: "3rem", maxWidth: "56ch" }}>
        {forList.map((item) => (
      ...
      <div className="wrap" style={{ marginBottom: "2rem", maxWidth: "52ch" }}>
        <p style={{ fontFamily: "var(--font-mono)", fontStyle: "normal", fontSize: "0.72rem", lineHeight: 2, letterSpacing: "0.02em", color: "var(--color-moss)", margin: "0 0 1.25rem" }}>
      ...
      <div className="wrap" style={{ marginBottom: "3rem", maxWidth: "44ch", textAlign: "center" }}>
        <p style={{ fontFamily: "var(--font-sans)", fontWeight: 300, fontSize: "0.9rem", lineHeight: 1.9, color: "var(--color-stone)", margin: 0 }}>
      ...
      <RevealStagger className="wrap" style={{ marginBottom: "5rem" }}>
        {journey.map((w) => (
          <div key={w.n} className="week-block" style={{ display: "grid", gridTemplateColumns: "3.5rem 1fr", gap: "1.5rem", borderTop: "1px solid var(--color-mist)", paddingTop: "1.5rem" }}>
            <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", fontWeight: 300, fontSize: "2.2rem", color: "var(--color-mist)", lineHeight: 1 }}>{w.n}</span>
            <div>
      ...
      <div className="wrap" style={{ marginBottom: "3rem" }}>
        ...
        <span style={{ display: "block", fontFamily: "var(--font-serif)", fontSize: "1.5rem", color: "var(--color-ink)" }}>Học phí: 05 triệu đồng</span>
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "2.5rem" }}>
        <span className="sec-title">các gói viết-đọc vị đồng hành //</span>
        <div className="price-row">
          <span>3 tháng</span>
          <span>5 triệu đồng</span>
        </div>
        <div className="price-row">
          <span>6 tháng</span>
          <span>9 triệu đồng</span>
        </div>
        <div className="price-row">
          <span>9 tháng</span>
          <span>12 triệu đồng</span>
        </div>
        <div className="price-row">
          <span>12 tháng</span>
          <span>15 triệu đồng</span>
        </div>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem" }}>
        <div style={{ border: "1px solid var(--color-mist)", borderRadius: "var(--radius-sharp)", padding: "2.25rem 2rem", maxWidth: "56ch" }}>
      ...
      <div className="wrap" style={{ marginBottom: "5rem", maxWidth: "52ch" }}>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "0.92rem", lineHeight: 1.85, color: "var(--color-ink)", margin: "0 0 1rem" }}>Người sáng lập mộc little farm.</p>
