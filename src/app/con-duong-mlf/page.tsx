  ...
  return (
    <>
      ...
      <Reveal className="wrap" style={{ marginTop: "2.5rem", marginBottom: "5rem", maxWidth: "56ch" }}>
        <p style={proseP}>
          qua các hoạt động như ngày-hiền, tuần-du, be-still, tea · mind, touch, giữa · middle, và cộng đồng ở-yên, mlf gieo những hạt mầm <strong>hiện diện</strong>, <strong>thong dong</strong>, và <strong>thấy rõ</strong> — để sống giản dị giữa đời thường.
        </p>
      </Reveal>
