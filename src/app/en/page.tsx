  ...
  return (
    <>
      ...
      <div style={{ marginTop: "2.5rem", marginLeft: "calc(-50vw + 50%)", marginRight: "calc(-50vw + 50%)", width: "100vw", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "0" }}>
        ...
        <ImagePlaceholder label="photo · tuần-du" aspectRatio="16/12" src="/assets/en_2.webp" alt="mộc little farm" style={{ width: "100%", height: "auto" }} />
        <ImagePlaceholder label="photo · thuan-duong" aspectRatio="16/12" src="/assets/thinhkhong02.webp" alt="mộc little farm" style={{ width: "100%", height: "auto" }} />
      </div>
