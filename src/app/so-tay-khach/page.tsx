...
const subLabel: React.CSSProperties = { display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--color-cham-dem)", marginBottom: "0.6rem" };
  ...
  return (
    <>
      ...
      <div className="wrap" style={{ paddingTop: "6.5rem", paddingBottom: "1rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>guest guide · sổ tay khách</span>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", maxWidth: "44ch", margin: 0 }}>một quyển sổ nhỏ dành cho người đến mộc little farm.</p>
      </div>

      {/* TOC */}
      <div className="wrap" style={{ marginTop: "3rem", marginBottom: "5rem", maxWidth: "56ch" }}>
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>nội dung</span>
        {tocItems.map((t) => (
          <a key={t.anchor} href={`#${t.anchor}`} className="row-b" style={{ display: "flex", alignItems: "baseline", gap: "0.8rem", color: "var(--color-ink)" }}>
            <span style={{ fontFamily: "var(--font-mono)", fontSize: "2rem", color: "var(--color-stone)" }}>{t.num}</span>
            <span style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem" }}>{t.label}</span>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>trước tiên</span>
      </div>
      <Reveal className="wrap" style={{ marginBottom: "3rem", maxWidth: "56ch" }}>
        ...
        <div style={{ textAlign: "center", margin: "1.5rem 0" }}>
          <span style={{ width: 4, height: 4, borderRadius: "50%", background: "var(--color-ink)", display: "inline-block" }} />
        </div>
        ...
        <p style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", fontSize: "0.9rem", lineHeight: 1.8, color: "var(--color-ink)", margin: "0 0 1.5rem" }}>
        ...
        <div style={{ borderLeft: "2px solid var(--color-ink)", padding: "0.2rem 0 0.2rem 1.1rem", margin: "1.5rem 0" }}>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem", marginTop: "2.5rem" }}>
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>triết lý</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        {philosophy.map((p) => (
          <div key={p.word} className="row-b" style={{ display: "grid", gridTemplateColumns: "5rem 1fr", alignItems: "baseline", gap: "1rem" }}>
            <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", fontSize: "1.4rem", color: "var(--color-cham-dem)" }}>{p.word}</span>
            <span style={{ fontFamily: "var(--font-sans)", fontSize: "0.86rem", color: "var(--color-ink)", lineHeight: 1.7 }}>{p.desc}</span>
          </div>
        ))}
      </Reveal>
      ...
      <div id="phan-1" className="wrap part-divider">
        ...
        <h2 className="part-title" style={{ fontFamily: "var(--font-serif)", fontWeight: 300, fontSize: "clamp(1.7rem, 5vw, 2.3rem)", color: "var(--color-ink)", margin: "0.4rem 0 0" }}>
          <span style={{ fontStyle: "normal", fontSize: "1.35em" }}>①</span> <span style={{ fontStyle: "italic" }}>trước khi đến</span>
        </h2>
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>hành trình đến mộc little farm</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        {steps.map((s) => (
          <div key={s.title} className="row-b" style={{ display: "grid", gridTemplateColumns: "1.5rem 1fr", gap: "0.9rem", alignItems: "baseline" }}>
            <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.8rem", color: "var(--color-cham-dem)" }}>→</span>
            <div>
              <div style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", fontWeight: 500, color: "var(--color-ink)", marginBottom: "0.3rem" }}>{s.title}</div>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        <div style={{ border: "1px solid var(--color-mist)", padding: "1.25rem 1.5rem", display: "flex", alignItems: "center", gap: "1.1rem" }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", color: "var(--color-ink)", marginBottom: "0.2rem" }}>mộc little farm</div>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>hướng dẫn di chuyển đến Măng Đen</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "3rem", maxWidth: "56ch" }}>
        <div className="row-b">
          ...
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: "0 0 0.5rem" }}>Điểm đến: sân bay Pleiku, Gia Lai.</p>
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Từ sân bay về Măng Đen: khoảng 100km, 2 giờ đi xe. Bạn có thể đặt xe khách hoặc thuê xe riêng. mlf có thể hỗ trợ kết nối nếu cần.</p>
        </div>
        <div className="row-b">
          <span style={subLabel}>xe khách</span>
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: "0 0 0.7rem" }}>Nhiều nhà xe chạy tuyến TP.HCM – Măng Đen qua đêm:</p>
          ...
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Đón tại Bến xe Miền Đông cũ.</p>
        </div>
        <div className="row-b">
          <span style={subLabel}>xe cá nhân</span>
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: "0 0 0.5rem" }}>Theo Quốc lộ QL24 từ thành phố Kon Tum lên Măng Đen. Cung đường đèo đẹp, nên đi ban ngày để thưởng thức.</p>
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Lưu ý: đường có thể trơn vào mùa mưa. Kiểm tra xe kỹ trước khi đi.</p>
        </div>
        ...
        <div className="row-b" style={kvRow}>
          ...
          <span style={{ ...kvVal, color: "var(--color-cham-dem)" }}>mlf sẽ gửi qua Zalo</span>
        </div>
      </Reveal>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>những điều cần mang theo</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: "0 0 1.5rem" }}>
          {personalItemsLine} — <span style={{ color: "var(--color-cham-dem)", fontStyle: "italic" }}>hạn chế đồ dùng một lần và rác thải nhựa.</span>
        </p>

        <span style={subLabel}>trang phục</span>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: "0 0 1.5rem" }}>Thời tiết hay thay đổi, hãy mang đủ: {clothingLine}.</p>

        <span style={subLabel}>nhà mộc đã chuẩn bị sẵn</span>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>{providedLine}</p>
      </Reveal>

      {/* 04 THỜI TIẾT */}
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.6rem", color: "var(--color-stone)", marginBottom: "0.3rem" }}>04</span>
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>thời tiết Măng Đen</span>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Măng Đen mát quanh năm, hay có sương, và rất nhiều gió.</p>
      </div>
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        <div className="grid2">
          {weatherCells.map((w) => (
            <div key={w.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: "1rem" }}>
              <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.62rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--color-ink)" }}>{w.label}</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        <div className="row-b" style={kvRow}>
          ...
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.68rem", color: "var(--color-ink)" }}>tháng 5 – 10 · chiều &amp; tối</span>
        </div>
        <div className="row-b" style={kvRow}>
          <span style={{ fontFamily: "var(--font-sans)", fontSize: "0.86rem", color: "var(--color-ink)" }}>Mùa khô</span>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.68rem", color: "var(--color-ink)" }}>tháng 11 – 4 · trời trong xanh</span>
        </div>
      </Reveal>
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Dù đến mùa nào, hãy mang áo khoác. Buổi sáng và đêm lúc nào cũng khá lạnh.</p>
      </Reveal>
      ...
      <div id="phan-2" className="wrap part-divider">
        ...
        <h2 className="part-title" style={{ fontFamily: "var(--font-serif)", fontWeight: 300, fontSize: "clamp(1.7rem, 5vw, 2.3rem)", color: "var(--color-ink)", margin: "0.4rem 0 0" }}>
          <span style={{ fontStyle: "normal", fontSize: "1.35em" }}>②</span> <span style={{ fontStyle: "italic" }}>khi ở</span>
        </h2>
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>nhịp ngày tại mlf</span>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>những gì có thể làm</span>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Khoảng tự do trong ngày, đây là những gì sẵn có:</p>
      </div>
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        {activityGroups.map((g) => (
          <div key={g.label} className="row-b">
            ...
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>{g.line}</p>
          </div>
        ))}
      </Reveal>
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch", textAlign: "center" }}>
        <span style={{ width: 4, height: 4, borderRadius: "50%", background: "var(--color-ink)", display: "inline-block", marginBottom: "1.5rem" }} />
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>những điều cùng giữ</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>{houseRulesLine}</p>
      </Reveal>
      ...
      <div id="phan-3" className="wrap part-divider">
        ...
        <h2 className="part-title" style={{ fontFamily: "var(--font-serif)", fontWeight: 300, fontSize: "clamp(1.7rem, 5vw, 2.3rem)", color: "var(--color-ink)", margin: "0.4rem 0 0" }}>
          <span style={{ fontStyle: "normal", fontSize: "1.35em" }}>③</span> <span style={{ fontStyle: "italic" }}>không gian</span>
        </h2>
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>bản đồ mlf</span>
      ...
      <div className="wrap" style={{ marginBottom: "1.2rem", maxWidth: "56ch" }}>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>Phòng ngủ được thiết kế vừa-đủ như một chiếc kén nhỏ để nghỉ ngơi.</p>
      </div>
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        <div className="grid2">
          {roomCells.map((r) => (
            <div key={r.name} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
              <span style={{ fontFamily: "var(--font-serif)", fontStyle: "italic", fontSize: "1rem", color: "var(--color-cham-dem)" }}>{r.name}</span>
              <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.56rem", letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--color-ink)" }}>{r.view}</span>
            </div>
          ))}
        </div>
      </Reveal>
      <Reveal className="wrap" style={{ marginBottom: "3.5rem", maxWidth: "56ch" }}>
        {roomInfo.map((i) => (
          <div key={i.k} className="row-b" style={{ display: "flex", justifyContent: "space-between", gap: "1rem" }}>
            <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.66rem", color: "var(--color-ink)", flex: "none" }}>{i.k}</span>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: "0 0 1.5rem" }}>{indoorAmenitiesLine}</p>

        <span style={{ ...subLabel, color: "var(--color-stone)" }}>bếp &amp; pha chế</span>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>{kitchenAmenitiesLine}</p>
      </Reveal>
      ...
      <div className="wrap" style={{ marginBottom: "0.8rem", maxWidth: "56ch" }}>
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>để nhắc lại mối quan hệ giữa mình với thức ăn, với đất, với mùa.</p>
      </div>
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        {foodInfo.map((i) => (
          <div key={i.k} className="row-b" style={{ display: "flex", justifyContent: "space-between", gap: "1rem" }}>
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>{homemadeFoodLine}</p>
      </Reveal>
      ...
      <div id="phan-4" className="wrap part-divider">
        ...
        <h2 className="part-title" style={{ fontFamily: "var(--font-serif)", fontWeight: 300, fontSize: "clamp(1.7rem, 5vw, 2.3rem)", color: "var(--color-ink)", margin: "0.4rem 0 0" }}>
          <span style={{ fontStyle: "normal", fontSize: "1.35em" }}>④</span> <span style={{ fontStyle: "italic" }}>retreat / stay+talk</span>
        </h2>
      </div>
      ...
      <div className="wrap" style={{ marginBottom: "1.5rem" }}>
        ...
        <span className="eyebrow" style={{ color: "var(--color-cham-dem)" }}>những điều nên chuẩn bị cho tâm</span>
      </div>
      <Reveal className="wrap" style={{ marginBottom: "2rem", maxWidth: "56ch" }}>
        {heartLines.map((h) => (
