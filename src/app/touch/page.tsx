  ...
  return (
    <>
      ...
      <div style={{ marginTop: "2.5rem", marginLeft: "calc(-50vw + 50%)", marginRight: "calc(-50vw + 50%)", width: "100vw", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "0" }}>
        <ImagePlaceholder label="ảnh · không gian touch 1" aspectRatio="16/12" src="/assets/cham01.jpg" alt="touch" style={{ width: "100%", height: "auto" }} />
        ...
        <ImagePlaceholder label="ảnh · không gian touch 3" aspectRatio="16/12" src="/assets/cham03.jpg" alt="touch" style={{ width: "100%", height: "auto" }} />
      </div>
