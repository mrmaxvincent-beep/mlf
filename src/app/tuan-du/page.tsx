    ...
    <>
        ...
        <div className="hscroll-clean" style={{ display: "flex", gap: "2.5rem", overflowX: "auto", justifyContent: "center", paddingBottom: "1.1rem", borderBottom: "1px solid var(--color-mist)" }}>
          {(
            [
              ...
              { n: "05", tier: "next" as const, href: routes.tuanDu05, status: "đã mở đăng ký" },
      ...
      <Reveal className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "3rem", marginTop: "1.4rem", flexWrap: "wrap" }}>
          ...
          <span style={{ fontFamily: "var(--font-sans)", fontSize: "0.85rem", lineHeight: 1.7, color: "var(--color-stone)", maxWidth: "20ch" }}>sự mở ra, chậm rãi mà tiếp xúc</span>
        </div>
      </Reveal>
      ...
      <Reveal className="wrap" style={{ marginBottom: "3rem", maxWidth: "46ch", textAlign: "center", margin: "0 auto 3rem" }}>
        ...
        <p style={{ fontFamily: "var(--font-sans)", fontSize: "1.05rem", lineHeight: 1.9, color: "var(--color-ink)", margin: 0 }}>
          tuần-du mang tinh thần của một mystery trip
          <br />
          vì tin rằng khi ta buông bớt sự kiểm soát, ta mới thực sự bắt đầu đi.
        </p>
      </Reveal>
