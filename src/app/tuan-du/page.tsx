  ...
  return (
    <>
      ...
      <div className="wrap" style={{ marginBottom: "3rem" }}>
        ...
        <p style={{ ...proseP, fontSize: "1.05rem", lineHeight: 1.9 }}>để thấy rằng, sống giữa đời sống này cần cả sự sôi động lẫn tĩnh lặng. Để còn biết, mỗi chiếc lá có một hình hài riêng, mỗi dòng sông có một khúc lượn, và trong lòng mình cũng có lắm những ỷ oi.</p>
