  ...
  return (
    <>
      ...
      <div className="wrap" style={{ marginBottom: "5rem" }}>
        <div style={{ borderLeft: "2px solid var(--color-moss)", padding: "1.75rem 2rem" }}>
      ...
      <div className="wrap" style={{ marginBottom: "1.75rem" }}>
        <div style={{ borderLeft: "2px solid var(--color-moss)", padding: "2rem" }}>
          ...
          <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.7rem", letterSpacing: "0.08em", color: "var(--color-moss)", marginBottom: "1.5rem" }}>
      ...
      <Reveal className="wrap feat-grid" style={{ marginTop: "2.5rem", marginBottom: "5rem" }}>
        {features.map((f) => (
          <div key={f.title}>
            <span style={{ display: "block", fontFamily: "var(--font-serif)", fontStyle: "italic", fontSize: "1.9rem", color: "var(--color-moss)", marginBottom: "0.7rem" }}>{f.icon}</span>
      ...
      <div className="wrap info-grid" style={{ marginBottom: "2.25rem" }}>
        {practical.map((p) => (
          <div key={p.label}>
            <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.45rem" }}>{p.label}</span>
      ...
      <div className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        <div style={{ marginBottom: "1.75rem", paddingBottom: "1.75rem", borderBottom: "1px solid var(--color-mist)" }}>
          <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.5rem" }}>vòng-trà</span>
        ...
        <div>
          <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.5rem" }}>tuần-du ký</span>
          <p style={{ fontFamily: "var(--font-sans)", fontSize: "0.9rem", lineHeight: 1.85, color: "var(--color-ink)", margin: 0, textAlign: "justify" }}>
      ...
      <div className="wrap info-grid" style={{ marginBottom: "2.5rem" }}>
        <div>
          <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.45rem" }}>chi phí</span>
        ...
        <div>
          <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.45rem" }}>số lượng tối đa</span>
      ...
      <div className="wrap" style={{ marginBottom: "5rem", maxWidth: "56ch" }}>
        {notes.map((n) => (
          <div key={n.title} style={{ paddingBottom: "2.25rem", marginBottom: "2.25rem", borderBottom: "1px solid var(--color-mist)" }}>
            <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.6rem" }}>{n.title}</span>
            {n.body.map((p) => (
        ...
        <div style={{ borderLeft: "2px solid var(--color-moss)", padding: "1.6rem 1.9rem" }}>
      ...
      <div className="wrap" style={{ marginBottom: "3.5rem" }}>
        <Accordion label="chính sách hoàn hủy">
          <div style={{ marginBottom: "2.5rem" }}>
            <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.9rem" }}>
          ...
          <div style={{ borderTop: "1px solid var(--color-mist)", paddingTop: "2.5rem", marginBottom: "2.5rem" }}>
            <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.5rem" }}>2. huỷ do bất khả kháng</span>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem" }} className="info-grid">
              <div style={{ padding: "1.5rem", border: "1px solid var(--color-mist)" }}>
                <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.7rem" }}>từ phía BTC</span>
              ...
              <div style={{ padding: "1.5rem", border: "1px solid var(--color-mist)" }}>
                <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.7rem" }}>từ phía người tham gia</span>
          ...
          <div style={{ borderTop: "1px solid var(--color-mist)", paddingTop: "2.5rem" }}>
            <span style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--color-moss)", marginBottom: "0.6rem" }}>
      ...
      <div className="wrap" style={{ marginBottom: "5rem", maxWidth: "52ch", textAlign: "center" }}>
        ...
        <a href="https://forms.gle/fBbYr3dUDHqZkh9bA" target="_blank" rel="noopener" className="cta-btn cta-btn--solid">
