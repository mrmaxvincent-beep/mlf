...
export default function TuanDu05Page() {
  return (
    <>
      ...
      <RevealStagger className="wrap stays-grid" style={{ marginBottom: "5rem" }}>
        {stays.map((s) => (
          <div key={s.place}>
            ...
            <p style={{ fontFamily: "var(--font-sans)", fontSize: "0.85rem", lineHeight: 1.75, color: "var(--color-ink)", margin: 0 }}>{s.desc}</p>
          </div>
        ))}
      </RevealStagger>
      ...
      <p className="wrap" style={{ maxWidth: 900, fontFamily: "var(--font-serif)", fontStyle: "italic", fontWeight: 300, fontSize: "clamp(0.91rem, 2.34vw, 1.37rem)", lineHeight: 1.6, color: "var(--color-ink)", margin: "0 auto 5rem", textAlign: "center" }}>
