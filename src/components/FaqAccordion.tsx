...
export function FaqAccordion({ items, initialCount = 6, collapsible = true }: { items: { q: string; a: string }[]; initialCount?: number; collapsible?: boolean }) {
  ...
  return <Accordion label="câu hỏi thường gặp">{list}</Accordion>;
}
