...
/** The recurring "trợ duyên" (sponsor / receive support) funding block — copied verbatim
 * (content and format) from the "CHÍNH SÁCH TRỢ DUYÊN" disclosure on retreat hàm-dưỡng. */
