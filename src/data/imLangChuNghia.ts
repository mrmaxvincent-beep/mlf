...
export const forList = [
  "những ai từng viết nhiều, nhưng giờ thấy chữ mình gắng gượng, thiếu hồn.",
  "những ai ngại viết, sợ chữ vì nghĩ mình không có khả năng.",
  "những ai muốn tìm giọng riêng, không vay mượn phong cách của ai.",
  "những ai cảm thấy viết có thể là một cách để trở về với mình.",
];

export const methods = [
  { n: "1", title: "viết bằng hơi thở", body: `Gắn nhịp câu với nhịp thở. Nhận ra đoạn nào "nghẽn" vì hơi thở bị kẹt.` },
  { n: "2", title: "viết bằng thân", body: "Kích hoạt 4 trung tâm: Tim (ấm), Bụng (vững), Gan (mạnh), Phổi (thoáng)." },
  { n: "3", title: "viết bằng khí", body: "Phân biệt chữ sống và chữ phẳng. Nghe khí của đoạn: có đẩy, có trụ, có ngân không?" },
  { n: "4", title: "im lặng là phương pháp", body: "Im lặng giúp bạn nghe được chữ rơi. Biết chữ đang muốn đi hướng nào." },
  { n: "5", title: "cấu trúc cây sống", body: "Gốc (Tâm) → Thân (Khí) → Cành (Kỹ thuật) → Lá (Thể loại). Giữ sự đồng bộ giữa tâm - khí - chữ." },
  { n: "6", title: "viết theo tự nhiên", body: "Đất (trầm, vững) • Nước (mềm, liền) • Lửa (dồn, bật) • Gió (thoáng, nhẹ)" },
];

export const journey = [
  {
    n: "0",
    week: "tuần 0 • trước khi vào lớp",
    title: "định hướng cá nhân",
    items: ["1 buổi 1-1 (90 phút): Nhận diện vướng mắc, đặt mục tiêu, định hình mạch học", "Nhận Nhật Ký Chữ Nghĩa (Google Docs cá nhân) để bắt đầu thực hành"],
  },
  {
    n: "1–4",
    week: "tuần 1 → tuần 4 • 30 ngày thực học",
    title: "thực hành & phản hồi",
    items: [
  ...
  { n: "5", week: "tuần 5 • tổng kết", title: "viết cùng nhau", items: ["Buổi viết tổng kết (90 phút): Cả lớp cùng ngồi lại trong tĩnh lặng, viết cùng nhau, rồi tổng kết hành trình 30 ngày."] },
];
...
export const sessions = [
  ...
  { n: "02", title: "Nghe chữ", desc: "Sau buổi này bạn tự đọc vị được đoạn văn của mình.", items: ["Nghe nhịp: câu chạy hay câu thở", "Nghe độ rơi: chữ rơi ở ngực hay ở bụng", "Nghe lực: chữ đẩy ra hay thu vào", "Nghe thân: chữ ấm, chữ trụ, chữ bén, chữ thoáng", "Âm mở và âm khóa trong tiếng Việt"] },
  { n: "03", title: "Nhịp và khoảng", desc: "Sau buổi này chữ của bạn có chỗ để thở.", items: ["Câu dài là một hơi nín, câu ngắn là một hơi thở", "Khoảng trống không phải chỗ bỏ phí, mà là chỗ chữ vang", "Sự co giãn của câu: khi nào dồn, khi nào trải", "Tám trạng thái dòng viết, nhận ra mình đang ở đâu"] },
  ...
  { n: "05", title: "Tinh luyện khí: Câu ngắn, chữ dày", items: ["Viết như gõ chuông: ngắn, gọn, nhưng còn ngân vang", "Tập rút câu, giữ lực", "Chữ ít mà dư ba", "Chữ và hình - Thân thể câu chữ", "Viết như Haiku"] },
  { n: "06", title: "Viết như hành khí – thở đều qua ngón tay", items: ["Nhịp tay - nhịp thở - nhịp chữ", "Tụ khí, chuyển hóa nó thành câu", "Hành khí bằng chữ (đặt khí, giữ khí)", "Ngón tay, cánh tay, vai", "Để chữ tự chảy, không phải đẩy"] },
...
export const overview = [
  "08 buổi Zoom nhóm (120 phút/buổi) vào thứ bảy, chủ nhật trong 4 tuần",
  "02 buổi 1-1 chuyên sâu (90 phút/buổi, trước và trong khóa học)",
  "30 ngày thực hành 15 công án chữ + phản hồi trên Google Docs",
  "01 buổi Viết tổng kết (sau 60 ngày)",
];

export const after30 = [
