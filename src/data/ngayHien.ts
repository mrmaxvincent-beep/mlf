...
export const programs = [
  {
    ...
    imgSrc: "/assets/ngayhien_staytalk.png",
  ...
  },
  {
    ...
    imgSrc: "/assets/ngayhien_oyen.png",
    imgObjectFit: "contain" as const,
    imgScale: 0.91,
  },
  {
    ...
    imgSrc: "/assets/ngayhien_hamduong.png",
    imgObjectFit: "contain" as const,
    imgScale: 0.845,
  },
  {
    ...
    imgSrc: "/assets/ngayhien_anvui.png",
    imgObjectFit: "contain" as const,
    imgScale: 0.845,
  },
];
...
export const moments = [
  { imgLabel: "ảnh · bàn ăn với hoa vườn", src: "/assets/ngayhien_mansuongsom.jpg", caption: `Lắm lúc, có những bất an bên trong nổi lên, tớ lại chờ đợi, tớ nhìn màn sương phủ khắp vườn, tớ nhìn con chim đang chao liệng giữa nền trời xam xám. Tớ đơn giản là chấp nhận nó như một phần của cuộc sống, hết nắng lại mưa, mọi thứ cứ tuần tự mà thành, đợi cho nỗi bất an tới lúc vụn vỡ, tan ra, rồi bình an lại tới. Rồi bình an lại rảo bước rời đi, nỗi bất an lại ghé thăm trong dịu dàng.` },
  { imgLabel: "ảnh · rót trà buổi tối", src: "/assets/home_vedem.jpg", caption: "Trời Măng Đen vẫn lúc nắng lúc mưa, gió sương vẫn bàng bạc núi đồi. Duy chỉ có một căn nhà tối tối thắp đèn, tiếng nhạc du dương, mùi bếp xông bồ kết, mùi bánh nướng, cốc nước thơm, những chồng sách, đóa hoa hái từ vườn, những tâm hồn thênh thang, một bầu không gian nội-tâm sâu sắc, có June luôn sẵn lòng yêu thương cứ lúi húi dưới chân, có Midnight nhẩn nhơ đối thoại với màn đêm, có những cuộc trò chuyện đi vào những chiều sâu tâm tưởng - lôi móc lên những điều cất giấu tận sâu bên trong... sự đan cài đã bện thành hơi thở, để chỉ thở thôi trong bầu không khí này, ta cũng tự thấy có điều gì đó đang ủi an." },
  { imgLabel: "ảnh · góc nhà quen thuộc", src: "/assets/ngayhien_demchuyentro.jpg", caption: `Ai mà không muốn được nhàn nhã, ai mà không muốn được thong dong, không ép thúc. Và rồi, những đêm ngồi lại cùng nhau, chúng tớ nói về những mặt kia của cuộc sống, để tự bản thân mỗi người học cách kéo mình về phía vốn bị lệch quá xa. Nhận biết mình đang đi về đâu, không phải là điều dễ dàng, nếu không có ai đó khẽ khàng lắc nhẹ vào vai mình: "Quay lại thôi!".` },
  { imgLabel: "ảnh · June ra đón khách trước cổng", src: "/assets/ngayhien_june.jpg", caption: "xe vừa dừng trước cổng, June từ trong nhà chạy ra. em đã mười tuổi, mắt đã đục hơn, răng đã rụng một chiếc — nhưng vẫn đón khách như một đứa trẻ. có người lên đây lần thứ ba, vẫn chưa nhớ đường vào nhà." },
  { imgLabel: "ảnh · một tối mưa, đọc sách bên đèn vàng", src: "/assets/ngayhien_docsach.jpg", caption: "một tối tháng mười, ngoài trời mưa vì ảnh hưởng của một cơn bão. trong nhà, đèn vàng dịu, nhạc mở khẽ, và mọi người đang êm ả đọc sách." },
  { imgLabel: "ảnh · quây quần bên bếp lửa", src: "/assets/ngayhien_bongnang.jpg", caption: "có những buổi chiều, bóng nắng đổ xuống. người ta chỉ muốn ngồi đó, nhìn mặt trời chầm chậm khuất dạng, cũng như những câu chuyện tự đến rồi tự đi." },
  { imgLabel: "ảnh · mẩu giấy thông điệp mỗi sáng", src: "/assets/ngayhien_buasang.jpg", caption: "mỗi buổi sáng, khách được bốc một mẩu giấy — thông điệp do một vị khách nào đó đi trước để lại. không ai biết ai viết. chỉ biết rằng, có một người từng ngồi đúng chỗ này, từng mang một nỗi niềm nào đó, và đã để lại vài dòng cho người đến sau." },
  { imgLabel: "ảnh · cắm hoa dại từ vườn mùa hạ", src: "/assets/ngayhien_camhoa.jpg", caption: "mùa hạ, có nắng, có gió và rất nhiều hoa cỏ. một sáng cuối tuần, có người dạo quanh khu vườn trước hiên, hái ít hoa dại, cắm một bình. vườn đang nở, và trong nhà nên có một chút của vườn." },
  { imgLabel: "ảnh · gian bếp mở, ai cũng thấy nhau nấu nướng", src: "/assets/ngayhien_bep.jpg", caption: `ở đây bếp, khách đi ngang thấy hết — ai đang nấu, ai đang rửa, ai đang lau bàn. có người viết trong lưu bút rằng, chỉ nhìn thấy cảnh mọi người nấu nướng rồi dọn dẹp trong bếp, "em đã hạnh phúc." hóa ra người ta không cần được phục vụ hoàn hảo. người ta cần thấy một đời sống thật đang diễn ra — và được ở trong đó.` },
];
