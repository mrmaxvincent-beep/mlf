...
export const days = [
  ...
  },
  {
    ...
    rows: [
      ...
      { time: "8:30 – 11:30", activity: "đi rừng: buổi hiểu về cơ thể" },
  ...
  },
  {
    ...
    rows: [
      { time: "6:00 – 7:00", activity: "vận động nhẹ cùng Thuận" },
      { time: "7:30 – 8:30", activity: "ăn sáng thong thả" },
      { time: "8:30 – 11:30", activity: "đi rừng: buổi hiểu về thế hệ con cháu" },
      { time: "11:30 – 15:00", activity: "nghỉ ngơi tự do, ăn trưa, ngủ trưa" },
  ...
  },
  {
    ...
    rows: [
      { time: "6:00 – 7:00", activity: "vận động nhẹ cùng Thuận" },
      { time: "7:30 – 8:30", activity: "ăn sáng thong thả" },
      { time: "8:30 – 11:30", activity: "đi rừng: vẽ tranh thiền" },
      { time: "11:30 – 15:00", activity: "nghỉ ngơi tự do, ăn trưa, ngủ trưa" },
...
export const faqs = [
  ...
  { q: "ở mlf có tuyệt đối yên tĩnh cho việc ngồi thiền hoặc cần sự tập trung cao độ không?", a: "Là nơi vùng cao, xung quanh chỉ toàn tiếng chim hót cả ngày. Thi thoảng hàng xóm có thể làm ồn một chút cho những cuộc vui của họ nhưng chúng tôi xem đó là cuộc sống, là cơ hội để quán xét lại tâm mình." },
