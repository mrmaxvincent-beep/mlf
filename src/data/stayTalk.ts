export const includesList = [
  { label: "xe đưa đón", val: "thị trấn Măng Đen" },
  { label: "lưu trú", val: "02 đêm" },
  { label: "bữa ăn", val: "02 bữa / ngày · trưa tự túc" },
  { label: "di chuyển", val: "có xe máy tự do khám phá" },
  { label: "buổi sáng", val: "picnic & trò chuyện bên suối" },
...
export const days = [
  {
    ...
    rows: [
      ...
      { time: "14:00", activity: "tea ceremony" },
      { time: "16:00", activity: "tự do khám phá" },
      { time: "19:00", activity: "ăn tối tại mlf" },
      { time: "20:00", activity: "xem phim tại mlf" },
    ],
  },
  {
    n: "2",
    rows: [
      { time: "6:30", activity: "ăn sáng tại mlf" },
      { time: "7:30", activity: "đi picnic trong rừng" },
      { time: "11:00", activity: "tự do ăn trưa và khám phá" },
      { time: "19:00", activity: "ăn tối tại mlf" },
      { time: "20:00", activity: "ngâm chân thảo mộc tại mlf" },
    ],
  },
  {
    n: "3",
    rows: [
      { time: "6:30", activity: "ăn sáng tại mlf" },
      { time: "7:30", activity: "workshop thủ công" },
      { time: "9:30", activity: "hoạt động tự do & ăn trưa tự túc" },
      { time: "15:00", activity: "nhà mộc đưa bạn ra xe trở về thành phố" },
    ],
  },
];
...
export const poemLines = [
  ...
  "lòng cũng nhẹ hơn đôi chút.",
  "bằng một chén trà ấm,",
  "mà lòng ta lại rộng mở thênh thang",
  "vừa buông lại nắm,",
  "vừa gần lại xa,",
  "vừa thong dong nhưng được neo lại,",
  "đó là khoảng vừa-vặn ở mlf",
];

export const policyLines = [
  "Trong trường hợp có lí do bất khả kháng chưa thể tham gia, vui lòng báo cho nhà mộc ít nhất 2 tuần trước khi diễn ra chương trình để được hoàn lại 100% chi phí.",
  "Bạn cũng có thể dời lịch tham gia chương trình đến thời điểm phù hợp — nhà mộc có chính sách bảo lưu đặt chỗ trong vòng 6 tháng hoặc tặng lại cho người khác.",
  "Trong trường hợp bạn hủy đặt chỗ trong vòng 15 ngày trước khi chương trình diễn ra, nhà mộc xin phép hoàn lại 80% chi phí của chương trình.",
];
